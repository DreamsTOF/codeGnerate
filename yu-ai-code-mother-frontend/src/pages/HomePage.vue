    ...
    <div class="container">
      ...
      <div class="quick-actions">
        <a-button
          ...
          @click="
      setPrompt(
        '创建一个AI数据分析仪表盘，用于展示关键业务指标。包含可定制的图表（折线图、柱状图、饼图）、数据表格、实时指标卡片和日期范围筛选器。设计一个深色主题的科技感界面，支持拖拽布局调整和模块化组件。'
      )
    "
        >AI 数据分析仪表盘</a-button
        >
        ...
        <a-button
          ...
          @click="
      setPrompt(
        '设计一个SaaS产品的营销落地页，用于吸引用户并转化注册。包含引人注目的英雄区域、功能特性介绍（带图标）、客户评价轮播、清晰的价格方案对比表和多步骤注册表单。采用现代、简洁的设计风格，并加入微交互和滚动动画效果。'
      )
    "
        >SaaS 产品落地页</a-button
        >
        ...
        <a-button
          ...
          @click="
      setPrompt(
        '构建一个在线学习平台的学员界面。包含我的课程列表、课程详情页（含课程大纲、讲师介绍）、视频播放器页面（带笔记功能和问答区）和学习进度跟踪仪表盘。界面设计应友好、直观，鼓励用户持续学习。'
      )
    "
        >在线课程平台</a-button
        >
        ...
        <a-button
          ...
          @click="
      setPrompt(
        '创建一个团队任务协作看板，类似于Trello。包含可拖拽的任务卡片、可自定义的列表（如“待办”、“进行中”、“已完成”）、任务详情模态框（可添加描述、附件、截止日期和评论）。支持多用户实时同步和成员头像展示。'
      )
    "
        >团队协作看板</a-button
        >
