...
import com.dream.codegenerate.ai.model.message.AiResponseMessage;
import com.dream.codegenerate.ai.model.message.ToolExecutedMessage;
import com.dream.codegenerate.ai.model.message.ToolRequestMessage;
...
public class AiCodeGeneratorFacade {
    ...
    public Flux<String> generateAndSaveCodeStream(UserMessage userMessage, CodeGenTypeEnum codeGenTypeEnum, Long appId) {
        ...
        return switch (codeGenTypeEnum) {
            ...
            case MULTI_FILE -> {
                Flux<String> codeStream = aiCodeGeneratorService.generateMultiFileCodeStream(userMessage.singleText());
